...
$(document).ready(function () {
    $("#aspFechaNac").datepicker({  format: 'dd/mm/yyyy' });
});
</script>
<div class="row">
  <div class="col-lg-12">
            ...
            <form>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" id="aspFechaNac" />
          ...
          <h2>Datos de contacto</h2> 
           <section>
            <form>
              <div class="form-row">
                <div class="form-group col-md-3">
                  <label for="aspTelAlt">*Tel&eacute;fono personal</span>
                  <input class="form-control form-control-sm" type="text" name="aspTelAlt" id="aspTelAlt" placeholder="">
                </div>
                <div class="form-group col-md-3">
                  <label for="aspCorreoI">Correo personal</span>
