            ...
            <div class="col-sm-12"> 
              ...
              <div class="clear"> 
                <div class="h3 m-t-xs m-b-xs " style="font-size: 30px;"> 
                  ...
                  <cfif prc.qAlumno.FK_ESTADO_AVANCE[1] lt 4>
        ...
        <div class="panel-body">
          <div class="tab-content">
                ...
                <section class="panel panel-default">
                    ...
                    <form class="bs-example form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <p class="form-control-static"> #dateFormat(prc.qAlumno.FECHA_NACIMIENTO[1],'dd/mm/yyy')# </p>
                        </div>
                      </div>
                      <div class="form-group">
            ...
            <div class="tab-pane fade" id="informacion-academica">
              ...
              <div class="col-sm-6">
              <div class="col-sm-2">
                <cfif prc.sEstudios.EstudiosProfesionales.FK_ESTATUS[1] eq 2>
                    <a style="font-size:25px" href="##"><i onclick="validacionEstudiosProf();" class="fa fa-unlock"></i></a>
                <cfelseif prc.sEstudios.EstudiosProfesionales.FK_ESTATUS[1] eq 3>
                    <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                </cfif>
              </div>
              ...
              <div class="col-sm-6">
                <section class="panel panel-default">
                    <div class="col-sm-2">
                    <cfif prc.sEstudios.EstudiosPostProfesionales.FK_ESTATUS[1] eq 2>
                      <a style="font-size:25px" href="##"><i onclick="validacionEstudiosPostProf();" class="fa fa-unlock"></i></a>
                    <cfelseif prc.sEstudios.EstudiosPostProfesionales.FK_ESTATUS[1] eq 3>
                        <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                    </cfif>
                    </div>
              ...
              <div class="col-sm-12">
                <section class="panel panel-default">
                <div class="col-sm-1">
					<cfif prc.sEstudios.Idiomas.FK_ESTATUS[1] eq 2>
                    <a style="font-size:25px" href="##"><i onclick="validacionIdiomas();" class="fa fa-unlock"></i></a>
                    <cfelseif prc.sEstudios.Idiomas.FK_ESTATUS[1] eq 3>
                        <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                    </cfif>
                  </div>
                    ...
                    <div class="col-sm-6">
                      <form class="form-horizontal" method="get">
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <label class="col-sm-7 control-label font-bold">ACEPTADO</label>
                          </div>
                        </div>
                      </form>
                    </div>
                    <div class="col-sm-6">
                      <form class="form-horizontal" method="get">
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <label class="col-sm-3 control-label font-bold">8.5</label>
                          </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <form class="form-horizontal" method="get">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <label class="col-sm-8 control-label font-bold">Mar&iacute;a Concha del Refugio</label>
                          </div>
                        </div>
                      </form>
                    </div>
            ...
            <div  class="col-sm-12">
              <section class="panel panel-default">
              <div class="col-sm-1">
                <cfif prc.sExperiencia.Experiencia.FK_ESTATUS[1] eq 2>
                    <a style="font-size:25px" href="##"><i onclick="validacionExperienciaProf();" class="fa fa-unlock"></i></a>
                <cfelseif prc.sExperiencia.Experiencia.FK_ESTATUS[1] eq 3>
                    <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                </cfif>
              </div>
              ...
              <section class="panel panel-default">
                  <div class="col-sm-1">
                    <cfif prc.sExperiencia.TrabInvestigacion.FK_ESTATUS[1] eq 2>
                        <a style="font-size:25px" href="##"><i onclick="validacionTrabajosInv();" class="fa fa-unlock"></i></a>
                    <cfelseif prc.sExperiencia.TrabInvestigacion.FK_ESTATUS[1] eq 3>
                        <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                    </cfif>
                  </div>
              ...
              <section class="panel panel-default">
                 <div class="col-sm-1">
                    <cfif prc.sExperiencia.LaborDocente.FK_ESTATUS[1] eq 2>
                        <a style="font-size:25px" href="##"><i onclick="validacionLaborDocente();" class="fa fa-unlock"></i></a>
                    <cfelseif prc.sExperiencia.LaborDocente.FK_ESTATUS[1] eq 3>
                        <a style="font-size:25px" href="##"><i class="fa fa-lock"></i></a>
                    </cfif>
                  </div>
        ...
        if (confirm('\u00BFDesea validar la informaci\u00f3n del alumno?')){
            $.post( "validacionGlobal?pkAlumno="+<cfoutput>#prc.pkAlumno#</cfoutput>, function( data ) {
                ...
                if (JSONObject.RESULTADO > 0) {
					...
					$('#eventStep1').val('SIP.detalle_alumno');
					$('#formStep1').submit();
                } else {
